    ...
    return (
        <>
            ...
            <div className='flex justify-center items-center w-full mt-12 '>
                <nav className='flex justify-around items-center p-3 sm:p-5 w-3/4 font-light z-50  border-white shadow-md rounded-xl bg-[#101723e1] fixed text-[15px] backdrop-blur'>
                    ...
                    <div className="rightnav text-lg lg:flex lg:justify-around lg:w-3/5 lg:tracking-wider 2xl:text-[2rem] duration-300 hidden">
                ...
                <div className='sideNav bg-[#101723b4] backdrop-blur-md fixed top-[25%] flex flex-col p-5 right-0 w-auto rounded-lg lg:hidden'>
