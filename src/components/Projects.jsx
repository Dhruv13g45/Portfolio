                ...
                <div className="projectSection w-full flex flex-col justify-center items-center">
                    {
                        ...
                        projInfo && projInfo.map((project) => (
                            ...
                            <div className="project w-full sm:w-3/4 flex flex-col lg:flex-row lg:justify-evenly lg:items-center bg-[#16192d93] p-10 gap-10 rounded-2xl my-10" key={project.projectName}>
                                <img src={project.projImg} alt="porjectbackground" className='w-full lg:w-1/2 sm:rounded-3xl rounded-md duration-300 hover:scale-105' />
                                <div>
                                    ...
                                    <div className='flex justify-around mt-5'>
                                        <NavLink to={project.repo} target="_blank">
                                            <button type="button" className='bg-[#1a1f3f93] p-3 xl:p-10 xl:rounded-xl xl:text-xl rounded-lg shadow-xl tracking-wider duration-300 hover:scale-105'>GitHub</button>
                                        </NavLink>
                                        <NavLink to={project.live} target="_blank">
                                            <button type="button" className="bg-[#1a1f3f93] p-3 xl:p-10 xl:rounded-xl xl:text-xl rounded-lg shadow-xl tracking-wider duration-300 hover:scale-105">Live</button>
                                        </NavLink>
                                    </div>
                                </div>
                            </div>
